...
public class Menu : MonoBehaviour {
		...
		void OnGUI() {
			//if(GUI.Button(new Rect(origin_x, origin_y, buttonWidth, buttonHeight), "Pyramid of Bones")) {
			//	Application.LoadLevel(1);
			//}
			if(GUI.Button(new Rect(origin_x, origin_y + buttonHeight + 10, buttonWidth, buttonHeight), "Pyramid of Bones")) {
